...
const Home = () => {
  return (
    <div className="bg-landing flex flex-col items-center justify-center space-y-5">
      <div>
        <h1 className="text-white font-semibold text-6xl z-10 animate-float">
      ...
      <div className="flex space-x-5">
        <Link to="/login">
          <Button label={"로그인"} fontSize="text-5xl" />
          <Button
            isDisabled={true}
            label={"로그인"}
            fontSize="text-5xl"
          ...
          />
          {/* <Button label={"로그인"} fontSize="text-5xl" /> */}
          <Button label={"계좌"} font="font-notoKR"></Button>
          <Button label={"계좌"} font="font-noto"></Button>
          <Button label={"로그인"} fontSize="text-4xl" />
          <Button label={"로그인"} fontSize="text-3xl" />
          <Button label={"로그인"} fontSize="text-2xl" />
          <Button label={"로그인"} fontSize="text-1xl" />
