...
import AccountPrepList from "../account/AccountPrepList";
        ...
        <div className="px-24 font-noto text-3xl">
          <header>
            <h2 className="font-hana2 font-semibold text-6xl py-10">
              선택하신{" "}
              <span className="text-hanaGreen">{productDetail.finPrdtNm}</span>{" "}
              가입 중입니다.
            </h2>
            <hr />
          </header>
          ...
          <div className="pb-10">
            ...
            <p className="font-hana2 leading-snug">
              이 상품에서 제공하는 우대금리( 0.2% )는 아래 내용의 각 항목들에
              대해 모두 동의를 하시는 경우에만 제공됩니다.
            </p>
          </div>
            ...
            <Accordion.Panel isOpen={true}>
              ...
              <Accordion.Content>
                <p className="leading-snug mb-5">
                  ...
                  <br />- 하나은행 및 하나금융그룹 계열사의 상품 또는 서비스의
                  안내 및 이용권유, 경품지급, 고객관리, 마케팅 조사
                </p>
                ...
                <p className="leading-snug mb-5">
                  ...
                  <br />* 위 보유 기간에서의 (금융)거래 종료일이란 “당 행과
                  거래중인 모든 계약(여·수신, 내·외국환, 카드 및 제3자 담보 제공
                  등) 해지 및 서비스(대여금고, 보호예수, 외국환거래지정,
                  인터넷뱅킹 포함 전자금융거래 등)가 종료된 날”을 말합니다.
                </p>
                ...
                <p className="leading-snug mb-5">
                  ...
                  이용권유, 경품지급, 고객관리 등”의 혜택을 받지 못할 수
                  있습니다.
                </p>
                ...
                <p className="leading-snug mb-5">
                  ...
                  <br />
                  우편, 택배 등에 의한 사은품, 경품 및 홍보물 등 배송업무
                  수행하는 두레시닝㈜, ㈜국민지에스, 외향산업㈜, ㈜다올커머스,
                  ㈜아워홈 등 업무 수탁자에게 제공합니다.
                  <br />
                  문자메시지 방식의 사은품, 경품 및 홍보물 등 전송 업무 수행하는
                  ㈜케이티, (주)쿠프마케팅, ㈜LG유플러스, ㈜엠티에스컴퍼니 등
                  문자메시지 서비스 업무 수탁자에게 제공합니다.
                  <br />
                  상품 또는 서비스 홍보 및 구매권유, 마케팅 조사(고객 만족도
                  조사 등)를 아이비커리어㈜, ㈜한국고용정보, 외향산업㈜,
                  고객센터등 업무 수탁자에게 제공합니다.
                </p>
              </Accordion.Content>
            </Accordion.Panel>
          </Accordion>
          ...
          <div className="bg-hanaRed/10 border border-hanaRed rounded-lg my-10 p-10">
            ...
            <p className="leading-snug mt-10 mb-5">
              ...
              <span className="text-black/50">
                ※ [귀 행]은 상품서비스 안내 등 수집·이용 목적을 달성하기 위하여
                위의 동의한 안내수단으로 본인에게 연락할 수 있습니다.
              </span>
            </p>
            ...
            <Accordion.Panel isOpen={true}>
              ...
              <Accordion.Content>
                ...
                <p className="leading-snug mb-5">
                  ...
                  있으며, “상품서비스의 홍보 및 권유를 위한” 선택적 사항이므로
                  동의하지 않더라도 (금융)거래 계약의 체결 및 이행에는 제한이
                  없습니다. 다만, 동의하지 않으시는 경우 “상품서비스 홍보 및
                  권유”를 받으실 수 없습니다.
                </p>
          ...
          <div className="my-10 px-10">
            <ul className="list-disc">
              <li className="leading-snug">
                ...
                수집∙이용∙제공에 관한 고객 권리안내문에 관하여 자세히 설명을
                듣고 수령하였습니다.
              </li>
              <li className="leading-snug">
                은행의 고의 또는 과실 등 귀책사유로 인한 개인정보 유출로
                손님에게 손해가 발생할 경우 관계 법령 등에따라 보상받으실 수
                있습니다.
              </li>
              <li className="leading-snug">
