...
function AutoTransfer() {
  ...
  // 로그인 정보에서 사용자 이름 가져와서 sender에 setFormData 해줘야 함
  useEffect(() => {
  ...
  const handleFormdata = () => {
    navigate("/transfer/confirm", { state: { formData, type: 'auto', selectedAccount:selectedAccountNumber } });
	};
...
<BankButtons handleChange={handleChange}/>
      </div><div className="form-group mb-6">
      ...
      </div><div className="form-group memo mb-6">
        <label className="font-hana2 font-semibold text-5xl block mb-12">
          통장에 표기할 내용 입력하기
        </label>
        <input
