  ...
  return (
    <div className="px-24 mb-24">
      ...
      <div className="flex flex-row mt-5 font-hana2 font-semibold text-6xl">
        <span className="text-hanaGreen">적금 상품 목록</span> &nbsp; 입니다.
      </div>
      <input
        type="text"
        id="success"
        className="mt-12 border font-hana2 placeholder-Gray dark:placeholder-green-500 text-3xl rounded-lg focus:ring-green-500 focus:border-green-500 block w-1/2 p-3 dark:bg-gray-700 dark:border-green-500 shadow-md hover:shadow-lg duration-300 ease-in-out"
        placeholder="검색"
      />
